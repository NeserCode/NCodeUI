<template>
  <viewBox :code="code">
    <div class="placeContainer">
      <nc-scrollbar :immediateHidden="true">
        <span v-for="i in 20" :key="i">{{ i }}</span>
      </nc-scrollbar>
    </div>
    <div class="placeContainer">
      <nc-scrollbar :immediateHidden="false">
        <span v-for="i in 20" :key="i">{{ i }}</span>
      </nc-scrollbar>
    </div>
    <div class="placeContainer">
      <nc-scrollbar :immediateHidden="false" :autoHidden="false">
        <span v-for="i in 20" :key="i">{{ i }}</span>
      </nc-scrollbar>
    </div>
  </viewBox>
...
.placeContainer {
  @apply relative w-40 h-64 mx-auto;
}
.placeContainer span {
